    ...
    <React.Fragment>
      ...
      <Wrapper>
        <Container flex={3}>
          <Section>
            <Content>
              <Content.Title large mb="10">{data?.name}</Content.Title>
              <div className="info">
          ...
          <Content.Title mb="10">Feature</Content.Title>
          <Section>
            <Container gap={25}>
              <Content flex>
                <Icons.Bed />
        ...
        <Container className="user" flex={1}>
          <Section style={{ justifyContent: "flex-start" }}>
            ...
            <Content>
              <div className="subTitle">Ilxomjon Developer</div>
              <div className="info">+998 88 123 45 67</div>
            </Content>
          </Section>
